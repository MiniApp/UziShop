...
public class GoodsFloorTools {
            ...
            for (Map map : list) {
                ...
                if (the_gc != null) {
                    ...
                    for (int i = 1; i <= count; ++i) {
                        GoodsClass child = this.goodsClassService.getObjById(CommUtil.null2Long(map.get("gc_id" + i)));
    ...
    public Map generic_goods_list(String json) {
        ...
        if ((json != null) && (!(json.equals("")))) {
            ...
            map.put("goods1", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id1"))));
            map.put("goods2", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id2"))));
            map.put("goods3", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id3"))));
            map.put("goods4", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id4"))));
            map.put("goods5", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id5"))));
            map.put("goods6", this.goodsService.getObjById(CommUtil.null2Long(list.get("goods_id6"))));
        }
        return map;
    }
    ...
    public String generic_adv(String web_url, String json) {
        ...
        if ((json != null) && (!(json.equals("")))) {
            ...
            if (CommUtil.null2String(map.get("adv_id")).equals("")) {
                ...
                template = template + "<a href='" + obj.getAp_acc_url() + "' target='_blank'><img src='" + web_url
                        + "/" + obj.getAp_acc().getPath() + "/" + obj.getAp_acc().getName() + "' /></a>";
            }
        }
