...
public class BargainManageTools {
    ...
    public int query_bargain_audit(Object bargain_time) {
        Map params = new HashMap();
        params.put("bt", bargain_time);
        List<BargainGoods> bargainGoods = this.bargainGoodsService.query("select obj from BargainGoods obj where obj.bg_time =:bt",
                params, -1, -1);
        int bd = 0;
    ...
    public int query_bargain_apply(Object bargain_time) {
        Map params = new HashMap();
        params.put("bt", bargain_time);
        List bargainGoods = this.bargainGoodsService.query("select obj from BargainGoods obj where obj.bg_time =:bt",
                params, -1, -1);
