...
import com.iskyshop.foundation.domain.query.SpareGoodsClassQueryObject;
import com.iskyshop.foundation.domain.query.SpareGoodsFloorQueryObject;
...
public class SpareGoodsFloorManageAction
{
  ...
  @SecurityMapping(title="闲置商品楼层列表", value="/admin/sparegoodsfloor_list.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层添加", value="/admin/sparegoodsfloor_add.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层编辑", value="/admin/sparegoodsfloor_edit.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层保存", value="/admin/sparegoodsfloor_save.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层ajax更新", value="/admin/sparegoodsfloor_ajax.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层删除", value="/admin/sparegoodsfloor_del.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层分类设置", value="/admin/sparegoodsfloor_setclass.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="商品楼层分类ajax更新", value="/admin/sparegoodsfloor_class_ajax.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层分类设置是否显示", value="/admin/sparegoodsfloor_setclass_switch.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层商品设置", value="/admin/sparegoodsfloor_setgoods.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
  ...
  @SecurityMapping(title="闲置商品楼层商品设置是否显示", value="/admin/sparegoodsfloor_setgoods_switch.htm*", rtype="admin", rname="闲置楼层", rcode="sparegoodsfloor_admin", rgroup="闲置")
