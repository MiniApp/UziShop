...
import com.iskyshop.foundation.domain.StoreGradeLog;
import com.iskyshop.foundation.domain.SysConfig;
import com.iskyshop.foundation.domain.User;
import com.iskyshop.foundation.domain.query.StoreGradeLogQueryObject;
...
import com.iskyshop.foundation.service.IStoreGradeLogService;
...
public class StoreManageAction
{
  ...
  public ModelAndView store_gradelog_save(HttpServletRequest request, HttpServletResponse response, String currentPage, String id, String cmd, String list_url)
    throws Exception
  {
    WebForm wf = new WebForm();
    StoreGradeLog obj = this.storeGradeLogService.getObjById(
