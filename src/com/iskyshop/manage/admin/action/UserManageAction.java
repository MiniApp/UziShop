...
public class UserManageAction
{
            ...
            for (Goods goods : parent.getStore().getGoods_list()) {
              ...
              for (GoodsCart gc : goodCarts) {
                ...
                List goodCarts2 = this.goodsCartService
                  ...
                  map2, -1, -1);
                if (goodCarts2.size() == 0) {
                  this.orderFormService.delete(ofid2);
                }
              }
  ...
  public ModelAndView user_msg_send(HttpServletRequest request, HttpServletResponse response, String type, String list_url, String users, String grades, String content)
    throws IOException
  {
    ModelAndView mv = new JModelAndView("admin/blue/success.html", 
      this.configService.getSysConfig(), this.userConfigService
    ...
    if (type.equals("the_store")) {
      ...
      int localUser1 = (arrayOfString = grades.split(",")).length; 
      for (int userInt = 0; userInt < localUser1; ++userInt) { 
          String grade = arrayOfString[userInt];
