...
public class StoreNavSellerAction {
    ...
    public ModelAndView store_nav_edit(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if ((id != null) && (!(id.equals("")))) {
            StoreNavigation storenavigation = this.storenavigationService.getObjById(Long.valueOf(Long.parseLong(id)));
    ...
    public ModelAndView store_nav_save(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if (id.equals("")) {
            ...
            StoreNavigation obj = this.storenavigationService.getObjById(Long.valueOf(Long.parseLong(id)));
    ...
    public String store_nav_del(HttpServletRequest request, HttpServletResponse response, String mulitId,
        ...
        for (String id : ids) {
            if (!(id.equals(""))) {
                StoreNavigation storenavigation = this.storenavigationService.getObjById(Long.valueOf(Long
                        .parseLong(id)));
