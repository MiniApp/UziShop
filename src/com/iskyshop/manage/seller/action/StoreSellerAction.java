  ...
  public ModelAndView store_create_finish(HttpServletRequest request, HttpServletResponse response, String sc_id, String grade_id, String area_id, String store_create_session)
  {
    ...
    if ((!store_create_session1.equals("")) && 
      ...
      if (store_status == 0) {
        ...
        StoreClass sc = this.storeClassService.getObjById(
          Long.valueOf(Long.parseLong(sc_id)));
        store.setSc(sc);
        StoreGrade grade = this.storeGradeService.getObjById(
          Long.valueOf(Long.parseLong(grade_id)));
        store.setGrade(grade);
        Area area = this.areaService
          .getObjById(Long.valueOf(Long.parseLong(area_id)));
        store.setArea(area);
