...
import com.iskyshop.foundation.domain.query.DeliveryLogQueryObject;
...
public class DeliverySellerAction {
    ...
    public ModelAndView delivery(HttpServletRequest request, HttpServletResponse response, String currentPage,
            String orderBy, String orderType) {
        ModelAndView mv = new JModelAndView("user/default/usercenter/delivery.html", this.configService.getSysConfig(),
    ...
    public ModelAndView delivery_log(HttpServletRequest request, HttpServletResponse response, String currentPage,
            String orderBy, String orderType) {
    ...
    public String delivery_buy_save(HttpServletRequest request, HttpServletResponse response, String count) {
        ...
        int delivery_gold = CommUtil.null2Int(count) * this.configService.getSysConfig().getDelivery_amount();
    ...
    public ModelAndView delivery_goods(HttpServletRequest request, HttpServletResponse response, String goods_name,
            String currentPage, String node_id) {
        ...
        CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/seller/delivery_goods.htm", "", "&goods_name="
                + goods_name, pList, mv);
    ...
    public ModelAndView delivery_apply_save(HttpServletRequest request, HttpServletResponse response,
            String main_goods_id, String give_goods_id, String delivery_session) {
        ModelAndView mv = new JModelAndView("success.html", this.configService.getSysConfig(),
                this.userConfigService.getUserConfig(), 1, request, response);
        String delivery_session1 = CommUtil.null2String(request.getSession(false).getAttribute("delivery_session"));
        if ((!(delivery_session1.equals(""))) && (delivery_session1.equals(delivery_session))) {
            ...
            Goods d_delivery_goods = this.goodsService.getObjById(CommUtil.null2Long(give_goods_id));
