...
public class SubAccountSellerAction {
    ...
    public ModelAndView sub_account_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
        ...
        uqo.addQuery("obj.parent.id", new SysMap("user_ids", SecurityUserHolder.getCurrentUser().getId()), "=");
    ...
    public ModelAndView sub_account_add(HttpServletRequest request, HttpServletResponse response) {
        ...
        List rgs = this.roleGroupService.query(
                "select obj from RoleGroup obj where obj.type=:type order by obj.addTime asc", params, -1, -1);
    ...
    public void sub_account_save(HttpServletRequest request, HttpServletResponse response, String id, String userName,
            String trueName, String sex, String birthday, String QQ, String telephone, String mobile, String password,
            String role_ids) {
        boolean ret = true;
        String msg = "保存成功";
