...
import com.iskyshop.foundation.domain.query.StorePartnerQueryObject;
...
public class StorePartnerManageAction {
    ...
    public ModelAndView store_partner(HttpServletRequest request, HttpServletResponse response, String currentPage,
        ...
        String params = "";
        StorePartnerQueryObject qo = new StorePartnerQueryObject(currentPage, mv, orderBy, orderType);
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/seller/store_partner.htm", "", params, pList, mv);
        return mv;
    }
    ...
    public ModelAndView store_partner_edit(HttpServletRequest request, HttpServletResponse response, String id,
            String currentPage) {
        ModelAndView mv = new JModelAndView("user/default/usercenter/store_partner_add.html",
                this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
        if ((id != null) && (!(id.equals("")))) {
            StorePartner storepartner = this.storepartnerService.getObjById(Long.valueOf(Long.parseLong(id)));
    ...
    public ModelAndView store_partner_save(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if (id.equals("")) {
            ...
            StorePartner obj = this.storepartnerService.getObjById(Long.valueOf(Long.parseLong(id)));
    ...
    public String store_partner_del(HttpServletRequest request, HttpServletResponse response, String mulitId,
            String currentPage) {
