...
public class QQLoginPlug
{
  ...
  public String qq_login_bind(HttpServletRequest request, HttpServletResponse response, String code)
  {
    ...
    String me_callback = CommUtil.null2String(
      getHttpContent(me_url, "UTF-8", "GET")).replaceAll(
      "callback\\(", "").replaceAll("\\);", "");
    ...
    if (SecurityUserHolder.getCurrentUser() == null) {
      String userName = generic_username(
        CommUtil.null2String(user_map.get("nickname")));
      ...
      return "redirect:" + CommUtil.getURL(request) + 
        ...
        "iskyshop_thid_login_" + user.getPassword();
    }
  ...
  public static void main(String[] args)
  {
    ...
    String redirect_uri = 
      CommUtil.encode("http://iskyshop.eicp.net/qq_login_bind.htm");
    String auth_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + 
