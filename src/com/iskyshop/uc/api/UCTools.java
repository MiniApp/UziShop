...
public class UCTools {
    ...
    public boolean active_user(String userName, String pws, String email) {
        ...
        try {
            ...
            String sql = "insert into " + this.configService.getSysConfig().getUc_table_preffix()
                    + "common_member (`email`,`username`,`password`,`regdate`,`groupid`) value ('" + email + "','"
                    + userName + "','" + pws + "','" + (System.currentTimeMillis() / 1000L) + "','10')";
    ...
    public Connection getConnection() {
        ...
        if (conn == null) {
            ...
            try {
                ...
                conn = DriverManager.getConnection("jdbc:mysql://" + UC_DATABASE_URL + ":" + UC_DATABASE_PORT + "/"
