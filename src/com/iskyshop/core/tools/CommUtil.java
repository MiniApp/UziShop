...
public class CommUtil {
    ...
    static {
        ...
        user_content_filter.addAttributes("embed", new String[] { "src", "quality", "width", "height",
    ...
    public static String showPageStaticHtml(String url, int currentPage, int pages) {
        ...
        if (pages > 0) {
            if (currentPage >= 1) {
                ...
                if (currentPage > 1) {
                    s = s + "<a href='" + url + "_" + (currentPage - 1) + ".htm'>��һҳ</a> ";
                }
            }
            ...
            if (currentPage <= pages) {
                ...
                s = s + "<a href='" + url + "_" + pages + ".htm'>ĩҳ</a> ";
            }
        }
        return s;
    }
    ...
    public static String showPageHtml(String url, String params, int currentPage, int pages) {
        ...
        if (pages > 0) {
            if (currentPage >= 1) {
                s = s + "<a href='" + url + "?currentPage=1" + params + "'>��ҳ</a> ";
                if (currentPage > 1) {
                    s = s + "<a href='" + url + "?currentPage=" + (currentPage - 1) + params + "'>��һҳ</a> ";
                }
            }
            int beginPage = (currentPage - 3 < 1) ? 1 : currentPage - 3;
            if (beginPage <= pages) {
            ...
            if (currentPage <= pages) {
                ...
                s = s + "<a href='" + url + "?currentPage=" + pages + params + "'>ĩҳ</a> ";
            }
        }
    ...
    public static String showPageFormHtml(int currentPage, int pages) {
        ...
        if (pages > 0) {
            if (currentPage >= 1) {
                s = s + "<a href='javascript:void(0);' onclick='return gotoPage(1)'>��ҳ</a> ";
                if (currentPage > 1) {
            ...
            if (currentPage <= pages) {
                ...
                s = s + "<a href='javascript:void(0);' onclick='return gotoPage(" + pages + ")'>ĩҳ</a> ";
            }
        }
    ...
    public static String showPageAjaxHtml(String url, String params, int currentPage, int pages) {
        ...
        if (pages > 0) {
            ...
            if (currentPage >= 1) {
                s = s + "<a href='javascript:void(0);' onclick='return ajaxPage(\"" + address + "\",1,this)'>��ҳ</a> ";
                s = s + "<a href='javascript:void(0);' onclick='return ajaxPage(\"" + address + "\","
                        + (currentPage - 1) + ",this)'>��һҳ</a> ";
            }
