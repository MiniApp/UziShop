...
public class Globals {
    public static final String DEFAULT_SYSTEM_TITLE = "ISkyShop���û��̳�ϵͳV1.4��Ѱ�";

    public static final boolean SSO_SIGN = true;

    public static final int DEFAULT_SHOP_VERSION = 20140301;

    public static final String DEFAULT_SHOP_OUT_VERSION = "V1.4";

    public static final String DEFAULT_WBESITE_NAME = "ISkyShop";

    public static final String DEFAULT_CLOSE_REASON = "ϵͳά����...";
