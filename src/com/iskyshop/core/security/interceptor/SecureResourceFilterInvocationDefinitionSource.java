...
public class SecureResourceFilterInvocationDefinitionSource implements FilterInvocationDefinitionSource,
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if ("true".equals(Boolean.valueOf(this.lowercaseComparisons))) {
            ...
            if ((!("false".equals(Boolean.valueOf(this.lowercaseComparisons)))) || (!(this.useAntPath)))
                return;
    ...
    public ConfigAttributeDefinition getAttributes(Object filter) throws IllegalArgumentException {
        ...
        if ((verify) && (requestURI.indexOf("login.htm") < 0)) {
            ...
            while (iter.hasNext()) {
                ...
                if ((CommUtil.null2String(url).equals("")) || (!(this.urlMatcher.pathMatchesUrl(url, requestURI))))
                    continue;
            ...
            filterInvocation.getHttpRequest().getSession().setAttribute("domain_error", Boolean.valueOf(true));
            return ((ConfigAttributeDefinition) configAttrEditor.getValue());
        }
