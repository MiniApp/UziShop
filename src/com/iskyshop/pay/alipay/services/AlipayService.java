...
public class AlipayService {
    ...
    public static String create_direct_pay_by_user(AlipayConfig config, Map<String, String> sParaTemp) {
        ...
        return AlipaySubmit.buildForm(config, sParaTemp, "https://mapi.alipay.com/gateway.do?", "get", strButtonName);
    }

    public static String query_timestamp(AlipayConfig config) throws MalformedURLException, DocumentException,
            IOException {
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + config.getPartner();
