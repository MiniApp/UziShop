...
package com.iskyshop.pay.tenpay.client;
...
public class ClientResponseHandler {
    ...
    public boolean isTenpaySign() {
        ...
        setDebugInfo(sb.toString() + " => sign:" + sign + " tenpaySign:" + tenpaySign);
    ...
    protected boolean isTenpaySign(String[] signParameterArray) {
        ...
        setDebugInfo(signPars.toString() + " => sign:" + sign + " tenpaySign:" + tenpaySign);
