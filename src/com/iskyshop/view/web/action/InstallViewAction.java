...
public class InstallViewAction implements ServletContextAware {
    ...
    public ModelAndView install(HttpServletRequest request, HttpServletResponse response, String install_status,
        ...
        ModelAndView mv = new JModelAndView("WEB-INF/templates/install/install1.html",
                this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 2, request, response);
        ...
        if (CommUtil.null2String(install_status).equals("install1")) {
            mv = new JModelAndView("WEB-INF/templates/install/install2.html", this.configService.getSysConfig(),
        ...
        if (CommUtil.null2String(install_status).equals("install2")) {
            mv = new JModelAndView("WEB-INF/templates/install/install3.html", this.configService.getSysConfig(),
                    this.userConfigService.getUserConfig(), 2, request, response);
    ...
    public ModelAndView install_view(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = new JModelAndView("WEB-INF/templates/install/install_view.html",
                this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 2, request, response);
        return mv;
    }
