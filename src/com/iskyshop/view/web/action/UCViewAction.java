...
public class UCViewAction {
    ...
    protected void iskyshop_login(HttpServletRequest request, HttpServletResponse response, Map<String, String> args) {
        boolean admin_login = CommUtil.null2Boolean(request.getSession(false).getAttribute("admin_login"));
        if (!(admin_login)) {
            ...
            String url = CommUtil.getURL(request) + "/iskyshop_login.htm?username=" + CommUtil.encode(userName)
                    + "&password=" + "iskyshop_thid_login_" + password + "&encode=true";
            try {
    ...
    protected void iskyshop_logout(HttpServletRequest request, HttpServletResponse response, Map<String, String> args) {
    ...
    protected void iskyshop_update_pws(HttpServletRequest request, HttpServletResponse response,
